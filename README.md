...
Join Town-Of-Us-R's [Discord](https://discord.gg/ugyc4EVUYZ) if you have any problems or want to find people to play with!
...
|----------|-------------|-----------------|
| 2024.9.4s & 2024.9.4e | v7.3.0 | [Download](https://github.com/Xslash58/Town-Of-Us-Twitch/releases/download/v7.3.0/ToU.v7.3.0.zip) |
...
<details>
  ...
  <h3>Fork:</h3>
  <ul> <li>New Role: Detonator</li> </ul>
  <ul> <li>New Modifier: Radiative</li> </ul>
  <ul> <li>New Start Animation</li> </ul>
  <ul> <li>Option to hide nicknames</li> </ul>
  <ul> <li>Fix: Mini now has larger range for tasks</li> </ul>
  <ul> <li>Fix: Disorienter now won't crash on Time Lord rewind</li> </ul>
  </details>
  <details>
  ...
  <h3>Fork:</h3>
  <ul> <li>New Modifiers: Upside-down, Mini</li> </ul>
  <ul> <li>New skins by ZIELONY_03</li> </ul>
...
<br/>
## Issues
If you have issues installing Town of Us, you can join our [Discord](https://discord.gg/ugyc4EVUYZ) to receive help. Keep in mind that this is a custom Fork, not related with Town-Of-Us-R.
...
The Detonator is an Impostor who has the ability to plant bombs on players instead of the ground to kill in any time.\
After a bomb is planted, the bomb will detonate once Detonator clicks the button.\
Once the bomb detonates it will kill all crewmates (and Impostors!) inside the radius (including the player who the bomb was planted on).
...
[ZIELONY_03](https://twitch.tv/ZIELONY_03), [xseba___](https://twitch.tv/xseba___) ,[WYSPA328](https://twitch.tv/WYSPA328) ,[ojmoty2](https://twitch.tv/ojmoty2), [Jerzuk_](https://twitch.tv/jerzuk_) - For skins you all made in this mod.\
